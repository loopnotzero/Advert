...
namespace Egghead.Controllers
{
    public class AdsTopicsController : Controller
    {
        ...
        public async Task<IActionResult> GetAdsTopics([FromQuery(Name = "page")] int page = 1, [FromQuery(Name = "keyword")] string keyword = null)
        {
            try
            {
                var adsTopicsPerPage = _configuration.GetSection("Egghead").GetValue<int>("AdsTopicsPerPage");                           
                ...
                var maxPages = _configuration.GetSection("Egghead").GetValue<int>("MaxPages");
        ...
        public async Task<IActionResult> GetAdsTopicContent(string adsId, [FromQuery(Name = "page")] int page = 1)
        {
            try
            {
                ...
                var adsTopics = await _adsTopicsManager.FindAdsTopicsAsync(_configuration.GetSection("Egghead").GetValue<int>("HowManyAdsTopicsPerPage"));
