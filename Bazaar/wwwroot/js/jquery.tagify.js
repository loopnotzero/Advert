...
!function (a) {
    ...
    a.fn.tagify = function () {
        ...
        DEFAULTS: {
            ...
            dropdown: {classname: "", enabled: 2, maxItems: 10, itemTemplate: ""}
        },
        ...
        build: function (t) {
            var e = this.DOM, i = '<tags class="tagify ' + (this.settings.mode ? "tagify--mix" : "") + " " + t.className + '" ' + (this.settings.readonly ? "readonly" : "") + '>\n                            <div contenteditable data-placeholder="' + (t.placeholder || "&#8203;") + '" class="tagify__input"></div>\n                        </tags>';
        ...
        events: {
            customBinding: function () {
                ...
                onFocusBlur: function (t) {
                    ...
                    }, n = this.state.tag, a = this.state.tag.value.length >= this.settings.dropdown.enabled)), this.update(), this.trigger("input", this.extend({}, this.state.tag, {textContent: this.DOM.input.textContent})), this.state.tag && this.dropdown[a ? "show" : "hide"].call(this, this.state.tag.value)
                    ...
                    var e = t.closest("tag"), i = this.input.normalize(t), s = i == t.originalValue || this.validateTag(i);
        ...
        validateTag: function (t) {
            var e = t.trim(), i = this.value.length >= this.settings.maxTags, s = !0;
        ...
        normalizeTags: function (t) {
            var i = this, e = this.settings.whitelist[0] instanceof Object, s = t instanceof Array && t[0] instanceof Object && "value" in t[0], n = [];
            if (s) return t;
        ...
        addMixTag: function (t) {
            if (t && this.state.tag) {
                for (var e, i, s, n, a = this.state.tag.prefix + this.state.tag.value, o = document.createNodeIterator(this.DOM.input, NodeFilter.SHOW_TEXT); e = o.nextNode();) if (e.nodeType === Node.TEXT_NODE) {
        ...
        addTags: function (t, e) {
            ...
            return this.DOM.input.removeAttribute("style"), t.forEach(function (t) {
                ...
                t = Object.assign({}, t), "function" == typeof s.settings.transformTag && (t.value = s.settings.transformTag.call(s, t.value) || t.value), !0 !== (e = s.validateTag.call(s, t.value)) && (t.class = t.class ? t.class + " tagify--notAllowed" : "tagify--notAllowed", t.title = e, s.markTagByValue(t.value), s.trigger("invalid", {
                    ...
                    message: e
                })), i = s.createTagElem(t), n.push(i), function (t) {
        ...
        createTagElem: function (t) {
            var e, i = this.escapeHtml(t.value), s = "<tag title='" + i + "' contenteditable='false' spellcheck=\"false\">\n                            <x title=''></x><div><span class='tagify__tag-text'>" + i + "</span></div>\n                        </tag>";
            if ("function" == typeof this.settings.tagTemplate) try {
                s = this.settings.tagTemplate(i, t)
            } catch (t) {
            }
            return this.settings.readonly && (t.readonly = !0), s = this.minify(s), function (t, e) {
        ...
        dropdown: {
            init: function () {
                ...
                binding: function () {
                    var t = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0], e = this.listeners.dropdown = this.listeners.dropdown || {
                    ...
                    onKeyDown: function (t) {
                        var e = this.DOM.dropdown.querySelectorAll("[class$='--active']")[0], i = "";
                        switch (t.key) {
                            case"ArrowDown":
                            case"ArrowUp":
                            case"Down":
                ...
                if (!t) return "";
                for (var e, i = [], s = this.settings.whitelist, n = this.settings.dropdown.maxItems || 1 / 0, a = 0; a < s.length && (0 == (e = s[a] instanceof Object ? s[a] : {value: s[a]}).value.toLowerCase().indexOf(t.toLowerCase()) && -1 == this.isTagDuplicate(e.value) && n-- && i.push(e), 0 != n); a++) ;
                return i
